...
def preprocessing(df, category_nm):
    # 공통 전처리 부분 / df 넘기기 전에 df 컬럼 [명칭, 위도, 경도] 로 통일할 것.
...
def load_Light(prvd_code='3220000',dong='역삼1동'):
    ### 보안등 - 원본 자료 부정확
    ...
    return preprocessing(dong_df2,'보안등')


def load_CCTV(dong='역삼동'):
    ...
    return preprocessing(dong_df2,'CCTV')


if __name__ == '__main__':
    print(load_Light().head(5)) #code, 동이름
    print(load_CCTV().head(5))  # code, 동이름
